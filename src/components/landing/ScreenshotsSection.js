...
const ScreenshotsSection = ({ isMobile, scrollPosition, language }) => {
  ...
  const screenshots = [
    {
      title: language === 'vi' ? 'Tổng Quan Bảng Điều Khiển' : 'Dashboard Overview',
      description: language === 'vi' 
        ? 'Xem toàn bộ tình hình tài chính của bạn trong một cái nhìn tổng quan.' 
    ...
    {
      title: language === 'vi' ? 'Quản Lý Giao Dịch' : 'Transaction Management',
      description: language === 'vi'
        ? 'Theo dõi tất cả thu nhập và chi tiêu của bạn với lịch sử chi tiết.'
        : 'Track all your income and expenses with detailed history.',
    ...
    {
      title: language === 'vi' ? 'Báo Cáo Tài Chính' : 'Financial Reports',
      description: language === 'vi'
        ? 'Tạo báo cáo chi tiết để phân tích các mô hình chi tiêu của bạn.'
        : 'Generate insightful reports to analyze your spending patterns.',
    ...
    },
    {
      ...
      description: language === 'vi'
        ? 'Thiết lập và theo dõi tiến trình đạt được các mục tiêu tài chính của bạn.'
  ...
  // Fixed animation variants with valid easing
      ...
      <Container maxWidth="lg">
        <Box sx={{ textAlign: 'center', mb: 8 }}>
          <Typography
            ...
            sx={{ mb: 2 }}
          >
            {language === 'vi' ? 'Hình Ảnh Ứng Dụng' : 'App Screenshots'}
          </Typography>
          ...
          >
            {language === 'vi' ? 'Xem Ứng Dụng Hoạt Động' : 'See the App in Action'}
          </Typography>
          ...
          >
            {language === 'vi'
              ? 'Khám phá giao diện trực quan được thiết kế để rõ ràng và dễ sử dụng'
